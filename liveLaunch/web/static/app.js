...
const REASON_ZH = new Map([
  ...
  ["completed before current live stage", "已完成，正在执行后续阶段"],
  ["waiting for current live stage", "等待当前阶段开始"],
  ["current live stage is running", "当前阶段正在运行"],
  ["completed before failed live stage", "已完成，后续阶段发生失败"],
  ["live run failed in this stage; inspect logs", "该阶段执行失败，请检查日志"],
