...
if __name__ == "__main__":
    ...
    parser.add_argument("--refresh", dest="refresh", action="store_true", help="force refresh mode")
    parser.add_argument("--no-refresh", dest="refresh", action="store_false", help="disable refresh mode")
    parser.set_defaults(refresh=None)
    parser.add_argument("--overwrite", dest="overwrite", action="store_true", help="force overwrite mode")
