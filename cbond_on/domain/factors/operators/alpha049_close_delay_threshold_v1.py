...
from cbond_on.domain.factors.operators._intraday_utils import _AlphaBase, _group_scalar, _prepare_panel


@FactorRegistry.register("alpha049_close_delay_threshold_v1")
class Alpha049CloseDelayThresholdV1Factor(_AlphaBase):
    name = "alpha049_close_delay_threshold_v1"
    ...
    def _compute_series(self, ctx: FactorComputeContext) -> pd.Series:
        ...
        threshold = float(ctx.params.get("threshold", -0.1))
