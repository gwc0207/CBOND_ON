...
@FactorRegistry.register("alpha051_close_delay_threshold_v2_v1")
class Alpha051CloseDelayThresholdV2V1Factor(_AlphaBase):
    name = "alpha051_close_delay_threshold_v2_v1"
