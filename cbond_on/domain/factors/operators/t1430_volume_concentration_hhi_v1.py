...
@FactorRegistry.register("t1430_volume_concentration_hhi_v1")
class T1430VolumeConcentrationHhiV1(Factor):
    def compute(self, ctx: FactorComputeContext) -> pd.Series:
        ...
        def _calc(group):
            ...
            # Filter out non-positive volumes for share calculation
