...
from cbond_on.domain.factors.defs import research_factor_mining_daily_incremental_v1 as incremental
...
def test_incremental_catalogue_has_five_distinct_families_and_explicit_registration() -> None:
    ...
    assert incremental.FactorMiningDailyIncrementalV1.__name__ not in factor_defs.__all__
