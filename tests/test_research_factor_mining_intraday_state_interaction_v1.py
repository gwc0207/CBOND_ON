...
from cbond_on.domain.factors.defs import research_factor_mining_intraday_state_interaction_v1 as interaction
...
def test_catalogue_has_six_distinct_families_and_import_only_registry() -> None:
    ...
    assert interaction.FactorMiningIntradayStateInteractionV1.__name__ not in factor_defs.__all__
