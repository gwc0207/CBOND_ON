...
from cbond_on.domain.factors.operators import research_factor_mining_daily_expansion_v1 as daily_expansion
...
def test_daily_expansion_catalogue_is_explicit_import_only_and_has_eight_families() -> None:
    ...
    assert daily_expansion.FactorMiningDailyExpansionV1.__name__ not in factor_operators.__all__
