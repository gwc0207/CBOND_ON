...
from cbond_on.domain.factors.defs import research_factor_mining_quote_geometry_microprice_v1 as geometry
...
def test_catalogue_has_four_two_signal_families_and_import_only_registration() -> None:
    ...
    assert geometry.FactorMiningQuoteGeometryMicropriceV1.__name__ not in factor_defs.__all__
