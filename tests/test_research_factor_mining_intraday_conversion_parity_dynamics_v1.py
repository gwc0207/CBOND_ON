...
from cbond_on.domain.factors.operators import research_factor_mining_intraday_conversion_parity_dynamics_v1 as parity
...
def test_catalogue_has_three_nonstatic_families_and_research_only_registration() -> None:
    ...
    assert parity.FactorMiningIntradayConversionParityDynamicsV1.__name__ not in factor_operators.__all__
